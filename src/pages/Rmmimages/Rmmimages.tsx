...
const imageItems = [
  { file: "/gallery/image1.jpg" },
  { file: "/gallery/image2.jpg" },
  { file: "/gallery/image3.jpg" },
  { file: "/gallery/image4.jpg" },
  ...
  return (
    <>
      ...
      <div className="bg-gray-200 m-4 py-12 px-4 sm:py-16 sm:px-6 lg:px-8">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-center text-teal-800">
          REACH Textile Studio Images
        </h1>
      </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            >
                ...
                <div className="w-full bg-gray-100 p-2 flex items-center justify-center rounded">
                  <img
                    src={item.file}
                    alt={`REACH Textile Studio image section ${index + 1}`}
