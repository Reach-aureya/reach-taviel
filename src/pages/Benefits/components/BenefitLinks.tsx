...
export const benefitPoints = [
  ...
  "High-quality visuals for marketing",
  "Strong brand storytelling",
  "Better collaboration across teams",
  "Reduced sampling cost",
  "Consistent brand identity",
  "Advanced control over textures and details",
  "Supports digital marketing workflows",
];
    ...
    <section className="bg-white text-gray-800 py-16">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-10">
          Benefits of using <span className="text-teal-400">REACH Taviel</span>
        </h2>
